...
export async function seed(): Promise<void> {
  ...
  await run(`
    ...
    VALUES
      (1, 1, '2026-03-18T09:00', '2026-03-18T11:00', 'Практична робота з мережевих технологій', 0),
      (2, 2, '2026-03-18T12:00', '2026-03-18T14:00', 'Проведення заняття в лабораторії', 0),
      (3, 3, '2026-03-19T10:30', '2026-03-19T13:00', 'Перевірка та налаштування обладнання', 0);
  `);
